<template>
  ...
  <el-dropdown-menu slot="dropdown">
    <el-dropdown-item command="a">文化艺术实践成绩</el-dropdown-item>
    <el-dropdown-item command="b">文化艺术竞赛获奖得分</el-dropdown-item>
  </el-dropdown-menu>
</el-dropdown>
  ...
  <div v-if="isShow1">
    <el-row :gutter="20">
     <div >
      <el-col :span="6">
  <el-input :disabled="true" placeholder="文化艺术实践成绩"></el-input>
</el-col>
...
<div>
  ...
  <div v-if="isShow2">
    <el-row :gutter="20">
     <div >
      <el-col :span="6">
  <el-input :disabled="true" placeholder="文化艺术竞赛获奖得分"></el-input>
</el-col>
      <el-col :span="6"> <el-select v-model="applilist.admin"  placeholder="请选择申报老师" @visible-change='selectTeacher'>
      <el-option
      v-for="item in options"
