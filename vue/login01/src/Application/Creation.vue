<template>
  ...
  <el-card class="creation-box-card">
    ...
    <el-dropdown-menu slot="dropdown">
      <el-dropdown-item command="a">创新创业竞赛获奖得分</el-dropdown-item>
      <el-dropdown-item command="b">水平等级考试</el-dropdown-item>
      <el-dropdown-item command="c">社会实践活动</el-dropdown-item>
    </el-dropdown-menu>
  </el-dropdown>
    ...
    <el-row :gutter="20">
     <div >
      <el-col :span="6">
  <el-input :disabled="true" placeholder="创新创业竞赛获奖得分"></el-input>
</el-col>
...
<div>
  ...
  <div v-if="isShow3">
    <el-row :gutter="20">
     <div >
      <el-col :span="6">
  <el-input :disabled="true" placeholder="社会实践活动"></el-input>
</el-col>
      <el-col :span="6"> <el-select v-model="applilist.admin"  placeholder="请选择申报老师" @visible-change='selectTeacher'>
      <el-option
      v-for="item in options"
...
data(){
  ...
  methods: {
      handleCommand(command) {
        if(command=='a'){
        this.isShow1=true;this.isShow2=false;this.isShow3=false;this.applilist.class=1;
        }
        if(command=='b'){
        this.isShow1=false;this.isShow2=true;this.isShow3=false;this.applilist.class=2;
        }
        if(command=='c'){
        this.isShow1=false;this.isShow2=false;this.isShow3=true;this.applilist.class=3;
